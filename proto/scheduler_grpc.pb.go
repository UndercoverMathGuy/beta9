...
const (
	...
	Scheduler_RunGang_FullMethodName      = "/scheduler.Scheduler/RunGang"
)
...
type SchedulerClient interface {
	...
	RunGang(ctx context.Context, in *RunGangRequest, opts ...grpc.CallOption) (*RunGangResponse, error)
}
...
func (c *schedulerClient) RunGang(ctx context.Context, in *RunGangRequest, opts ...grpc.CallOption) (*RunGangResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RunGangResponse)
	err := c.cc.Invoke(ctx, Scheduler_RunGang_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SchedulerServer interface {
	...
	RunGang(context.Context, *RunGangRequest) (*RunGangResponse, error)
...
func (UnimplementedSchedulerServer) RunGang(context.Context, *RunGangRequest) (*RunGangResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RunGang not implemented")
}
...
func _Scheduler_RunGang_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RunGangRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SchedulerServer).RunGang(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Scheduler_RunGang_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SchedulerServer).RunGang(ctx, req.(*RunGangRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Scheduler_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RunGang",
			Handler:    _Scheduler_RunGang_Handler,
		},
	},
