...
const file_function_proto_rawDesc = "" +
	...
	"\x10scheduled_job_id\x18\x03 \x01(\tR\x0escheduledJobId2\xdb\x03\n" +
	"\x0fFunctionService\x12W\n" +
	"\x0eFunctionInvoke\x12\x1f.function.FunctionInvokeRequest\x1a .function.FunctionInvokeResponse\"\x000\x01\x12X\n" +
