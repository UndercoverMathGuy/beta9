...
const file_queue_proto_rawDesc = "" +
	"\n" +
	"\vqueue.proto\x12\vsimplequeue\"A\n" +
	"\x15SimpleQueuePutRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05value\x18\x02 \x01(\fR\x05value\"(\n" +
	"\x16SimpleQueuePutResponse\x12\x0e\n" +
	"\x02ok\x18\x01 \x01(\bR\x02ok\"A\n" +
	"\x15SimpleQueuePopRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05value\x18\x02 \x01(\fR\x05value\">\n" +
	"\x16SimpleQueuePopResponse\x12\x0e\n" +
	"\x02ok\x18\x01 \x01(\bR\x02ok\x12\x14\n" +
	"\x05value\x18\x02 \x01(\fR\x05value\"?\n" +
	"\x17SimpleQueuePeekResponse\x12\x0e\n" +
	"\x02ok\x18\x01 \x01(\bR\x02ok\x12\x14\n" +
	"\x05value\x18\x02 \x01(\fR\x05value\"@\n" +
	"\x18SimpleQueueEmptyResponse\x12\x0e\n" +
	"\x02ok\x18\x01 \x01(\bR\x02ok\x12\x14\n" +
	"\x05empty\x18\x02 \x01(\bR\x05empty\"=\n" +
	"\x17SimpleQueueSizeResponse\x12\x0e\n" +
	"\x02ok\x18\x01 \x01(\bR\x02ok\x12\x12\n" +
	"\x04size\x18\x02 \x01(\x04R\x04size\"(\n" +
	"\x12SimpleQueueRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name2\xe4\x03\n" +
	"\x12SimpleQueueService\x12[\n" +
	"\x0eSimpleQueuePut\x12\".simplequeue.SimpleQueuePutRequest\x1a#.simplequeue.SimpleQueuePutResponse\"\x00\x12[\n" +
	"\x0eSimpleQueuePop\x12\".simplequeue.SimpleQueuePopRequest\x1a#.simplequeue.SimpleQueuePopResponse\"\x00\x12Z\n" +
	"\x0fSimpleQueuePeek\x12\x1f.simplequeue.SimpleQueueRequest\x1a$.simplequeue.SimpleQueuePeekResponse\"\x00\x12\\\n" +
	"\x10SimpleQueueEmpty\x12\x1f.simplequeue.SimpleQueueRequest\x1a%.simplequeue.SimpleQueueEmptyResponse\"\x00\x12Z\n" +
	"\x0fSimpleQueueSize\x12\x1f.simplequeue.SimpleQueueRequest\x1a$.simplequeue.SimpleQueueSizeResponse\"\x00B#Z!github.com/beam-cloud/beta9/protob\x06proto3"
