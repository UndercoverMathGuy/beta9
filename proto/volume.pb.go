...
const file_volume_proto_rawDesc = "" +
	"\n" +
	"\fvolume.proto\x12\x06volume\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/api/annotations.proto\"\x88\x02\n" +
	"\x0eVolumeInstance\x12\x0e\n" +
	...
	"\x0eworkspace_name\x18\a \x01(\tR\rworkspaceName\".\n" +
	"\x18GetOrCreateVolumeRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"t\n" +
	"\x19GetOrCreateVolumeResponse\x12\x0e\n" +
	"\x02ok\x18\x01 \x01(\bR\x02ok\x12\x17\n" +
	"\aerr_msg\x18\x02 \x01(\tR\x06errMsg\x12.\n" +
	"\x06volume\x18\x03 \x01(\v2\x16.volume.VolumeInstanceR\x06volume\")\n" +
	"\x13DeleteVolumeRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"?\n" +
	"\x14DeleteVolumeResponse\x12\x0e\n" +
	"\x02ok\x18\x01 \x01(\bR\x02ok\x12\x17\n" +
	"\aerr_msg\x18\x02 \x01(\tR\x06errMsg\"\x80\x01\n" +
	"\bPathInfo\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04path\x12\x12\n" +
	"\x04size\x18\x02 \x01(\x04R\x04size\x125\n" +
	"\bmod_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\amodTime\x12\x15\n" +
	"\x06is_dir\x18\x04 \x01(\bR\x05isDir\"%\n" +
	"\x0fListPathRequest\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04path\"l\n" +
	"\x10ListPathResponse\x12\x0e\n" +
	"\x02ok\x18\x01 \x01(\bR\x02ok\x12\x17\n" +
	"\aerr_msg\x18\x02 \x01(\tR\x06errMsg\x12/\n" +
	"\n" +
	"path_infos\x18\x03 \x03(\v2\x10.volume.PathInfoR\tpathInfos\"'\n" +
	"\x11DeletePathRequest\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04path\"W\n" +
	"\x12DeletePathResponse\x12\x0e\n" +
	"\x02ok\x18\x01 \x01(\bR\x02ok\x12\x17\n" +
	"\aerr_msg\x18\x02 \x01(\tR\x06errMsg\x12\x18\n" +
	"\adeleted\x18\x03 \x03(\tR\adeleted\"?\n" +
	"\x0fCopyPathRequest\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04path\x12\x18\n" +
	"\acontent\x18\x02 \x01(\fR\acontent\"X\n" +
	"\x10CopyPathResponse\x12\x0e\n" +
	"\x02ok\x18\x01 \x01(\bR\x02ok\x12\x1b\n" +
	"\tobject_id\x18\x02 \x01(\tR\bobjectId\x12\x17\n" +
	"\aerr_msg\x18\x03 \x01(\tR\x06errMsg\"\x14\n" +
	"\x12ListVolumesRequest\"p\n" +
	"\x13ListVolumesResponse\x12\x0e\n" +
	"\x02ok\x18\x01 \x01(\bR\x02ok\x12\x17\n" +
	"\aerr_msg\x18\x02 \x01(\tR\x06errMsg\x120\n" +
	"\avolumes\x18\x03 \x03(\v2\x16.volume.VolumeInstanceR\avolumes\"Q\n" +
	"\x0fMovePathRequest\x12#\n" +
	"\roriginal_path\x18\x01 \x01(\tR\foriginalPath\x12\x19\n" +
	"\bnew_path\x18\x02 \x01(\tR\anewPath\"V\n" +
	"\x10MovePathResponse\x12\x0e\n" +
	"\x02ok\x18\x01 \x01(\bR\x02ok\x12\x17\n" +
	...
	"\x02ok\x18\x01 \x01(\bR\x02ok\x12\x17\n" +
	"\aerr_msg\x18\x02 \x01(\tR\x06errMsg\x12-\n" +
	"\tpath_info\x18\x03 \x01(\v2\x10.volume.PathInfoR\bpathInfo\"\x9c\x01\n" +
	"\x12PresignedURLParams\x12\x1b\n" +
	...
	"\fcontent_type\x18\x04 \x01(\tR\vcontentType\"\x1b\n" +
	"\x19GetFileServiceInfoRequest\"\x88\x01\n" +
	"\x1aGetFileServiceInfoResponse\x12\x0e\n" +
	"\x02ok\x18\x01 \x01(\bR\x02ok\x12\x17\n" +
	"\aerr_msg\x18\x02 \x01(\tR\x06errMsg\x12\x18\n" +
	"\aenabled\x18\x03 \x01(\bR\aenabled\x12'\n" +
	"\x0fcommand_version\x18\x04 \x01(\rR\x0ecommandVersion\"\xdf\x01\n" +
	"\x19CreatePresignedURLRequest\x12\x1f\n" +
	"\vvolume_name\x18\x01 \x01(\tR\n" +
	"volumeName\x12\x1f\n" +
	"\vvolume_path\x18\x02 \x01(\tR\n" +
	"volumePath\x12\x18\n" +
	"\aexpires\x18\x03 \x01(\rR\aexpires\x122\n" +
	"\x06method\x18\x04 \x01(\x0e2\x1a.volume.PresignedURLMethodR\x06method\x122\n" +
	"\x06params\x18\x05 \x01(\v2\x1a.volume.PresignedURLParamsR\x06params\"W\n" +
	"\x1aCreatePresignedURLResponse\x12\x0e\n" +
	"\x02ok\x18\x01 \x01(\bR\x02ok\x12\x17\n" +
	"\aerr_msg\x18\x02 \x01(\tR\x06errMsg\x12\x10\n" +
	"\x03url\x18\x03 \x01(\tR\x03url\"\x9c\x01\n" +
	"\x1cCreateMultipartUploadRequest\x12\x1f\n" +
	"\vvolume_name\x18\x01 \x01(\tR\n" +
	"volumeName\x12\x1f\n" +
	"\vvolume_path\x18\x02 \x01(\tR\n" +
	"volumePath\x12\x1d\n" +
	...
	"\tfile_size\x18\x04 \x01(\x04R\bfileSize\"b\n" +
	"\x0eFileUploadPart\x12\x16\n" +
	...
	"\x1dCreateMultipartUploadResponse\x12\x0e\n" +
	"\x02ok\x18\x01 \x01(\bR\x02ok\x12\x17\n" +
	"\aerr_msg\x18\x02 \x01(\tR\x06errMsg\x12\x1b\n" +
	"\tupload_id\x18\x03 \x01(\tR\buploadId\x12B\n" +
	"\x11file_upload_parts\x18\x04 \x03(\v2\x16.volume.FileUploadPartR\x0ffileUploadParts\";\n" +
	...
	"volumePath\x12>\n" +
	"\x0fcompleted_parts\x18\x04 \x03(\v2\x15.volume.CompletedPartR\x0ecompletedParts\"J\n" +
	"\x1fCompleteMultipartUploadResponse\x12\x0e\n" +
	"\x02ok\x18\x01 \x01(\bR\x02ok\x12\x17\n" +
	...
	"\vvolume_path\x18\x03 \x01(\tR\n" +
	"volumePath\"G\n" +
	"\x1cAbortMultipartUploadResponse\x12\x0e\n" +
	"\x02ok\x18\x01 \x01(\bR\x02ok\x12\x17\n" +
	"\aerr_msg\x18\x02 \x01(\tR\x06errMsg*R\n" +
	"\x12PresignedURLMethod\x12\r\n" +
	"\tGetObject\x10\x00\x12\r\n" +
	"\tPutObject\x10\x01\x12\x0e\n" +
	"\n" +
	"HeadObject\x10\x02\x12\x0e\n" +
	"\n" +
	"UploadPart\x10\x032\xec\v\n" +
	"\rVolumeService\x12m\n" +
	"\x11GetOrCreateVolume\x12 .volume.GetOrCreateVolumeRequest\x1a!.volume.GetOrCreateVolumeResponse\"\x13\x82\xd3\xe4\x93\x02\r:\x01*\"\b/volumes\x12l\n" +
	"\fDeleteVolume\x12\x1b.volume.DeleteVolumeRequest\x1a\x1c.volume.DeleteVolumeResponse\"!\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/volumes/{name}/delete\x12X\n" +
	"\vListVolumes\x12\x1a.volume.ListVolumesRequest\x1a\x1b.volume.ListVolumesResponse\"\x10\x82\xd3\xe4\x93\x02\n" +
	"\x12\b/volumes\x12V\n" +
	"\bListPath\x12\x17.volume.ListPathRequest\x1a\x18.volume.ListPathResponse\"\x17\x82\xd3\xe4\x93\x02\x11\x12\x0f/volumes/{path}\x12f\n" +
	"\n" +
	"DeletePath\x12\x19.volume.DeletePathRequest\x1a\x1a.volume.DeletePathResponse\"!\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/volumes/{path}/delete\x12d\n" +
	"\x0eCopyPathStream\x12\x17.volume.CopyPathRequest\x1a\x18.volume.CopyPathResponse\"\x1d\x82\xd3\xe4\x93\x02\x17:\x01*\"\x12/volumes/copy-path(\x01\x12g\n" +
	"\bMovePath\x12\x17.volume.MovePathRequest\x1a\x18.volume.MovePathResponse\"(\x82\xd3\xe4\x93\x02\":\x01*\"\x1d/volumes/{original_path}/move\x12[\n" +
	"\bStatPath\x12\x17.volume.StatPathRequest\x1a\x18.volume.StatPathResponse\"\x1c\x82\xd3\xe4\x93\x02\x16\x12\x14/volumes/{path}/stat\x12\x7f\n" +
	"\x12GetFileServiceInfo\x12!.volume.GetFileServiceInfoRequest\x1a\".volume.GetFileServiceInfoResponse\"\"\x82\xd3\xe4\x93\x02\x1c\x12\x1a/volumes/file-service-info\x12~\n" +
	"\x12CreatePresignedURL\x12!.volume.CreatePresignedURLRequest\x1a\".volume.CreatePresignedURLResponse\"!\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/volumes/presigned-url\x12\x8a\x01\n" +
	"\x15CreateMultipartUpload\x12$.volume.CreateMultipartUploadRequest\x1a%.volume.CreateMultipartUploadResponse\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\"\x19/volumes/multipart-upload\x12\x99\x01\n" +
	"\x17CompleteMultipartUpload\x12&.volume.CompleteMultipartUploadRequest\x1a'.volume.CompleteMultipartUploadResponse\"-\x82\xd3\xe4\x93\x02':\x01*\"\"/volumes/multipart-upload/complete\x12\x8d\x01\n" +
	"\x14AbortMultipartUpload\x12#.volume.AbortMultipartUploadRequest\x1a$.volume.AbortMultipartUploadResponse\"*\x82\xd3\xe4\x93\x02$:\x01*\"\x1f/volumes/multipart-upload/abortB#Z!github.com/beam-cloud/beta9/protob\x06proto3"
