...
type GatewayServiceClient interface {
	...
	PutObjectStream(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[PutObjectRequest, PutObjectResponse], error)
	// Containers
	...
	AttachToContainer(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ContainerStreamMessage, AttachToContainerResponse], error)
	// Tasks
...
func (c *gatewayServiceClient) CreateObject(ctx context.Context, in *CreateObjectRequest, opts ...grpc.CallOption) (*CreateObjectResponse, error) {
	...
	err := c.cc.Invoke(ctx, GatewayService_CreateObject_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayServiceClient) PutObjectStream(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[PutObjectRequest, PutObjectResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type GatewayService_PutObjectStreamClient = grpc.ClientStreamingClient[PutObjectRequest, PutObjectResponse]
...
func (c *gatewayServiceClient) CheckpointContainer(ctx context.Context, in *CheckpointContainerRequest, opts ...grpc.CallOption) (*CheckpointContainerResponse, error) {
	...
	err := c.cc.Invoke(ctx, GatewayService_CheckpointContainer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayServiceClient) AttachToContainer(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ContainerStreamMessage, AttachToContainerResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &GatewayService_ServiceDesc.Streams[1], GatewayService_AttachToContainer_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[ContainerStreamMessage, AttachToContainerResponse]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GatewayService_AttachToContainerClient = grpc.BidiStreamingClient[ContainerStreamMessage, AttachToContainerResponse]
...
type GatewayServiceServer interface {
	...
	PutObjectStream(grpc.ClientStreamingServer[PutObjectRequest, PutObjectResponse]) error
	// Containers
	...
	AttachToContainer(grpc.BidiStreamingServer[ContainerStreamMessage, AttachToContainerResponse]) error
	// Tasks
...
func (UnimplementedGatewayServiceServer) SignPayload(context.Context, *SignPayloadRequest) (*SignPayloadResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SignPayload not implemented")
}
...
func (UnimplementedGatewayServiceServer) PutObjectStream(grpc.ClientStreamingServer[PutObjectRequest, PutObjectResponse]) error {
...
func (UnimplementedGatewayServiceServer) AttachToContainer(grpc.BidiStreamingServer[ContainerStreamMessage, AttachToContainerResponse]) error {
	return status.Error(codes.Unimplemented, "method AttachToContainer not implemented")
}
...
func (UnimplementedGatewayServiceServer) GetOrCreateStub(context.Context, *GetOrCreateStubRequest) (*GetOrCreateStubResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetOrCreateStub not implemented")
}
func (UnimplementedGatewayServiceServer) DeployStub(context.Context, *DeployStubRequest) (*DeployStubResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeployStub not implemented")
}
...
func (UnimplementedGatewayServiceServer) ToggleToken(context.Context, *ToggleTokenRequest) (*ToggleTokenResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ToggleToken not implemented")
}
...
func (UnimplementedGatewayServiceServer) CordonWorker(context.Context, *CordonWorkerRequest) (*CordonWorkerResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CordonWorker not implemented")
}
func (UnimplementedGatewayServiceServer) UncordonWorker(context.Context, *UncordonWorkerRequest) (*UncordonWorkerResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UncordonWorker not implemented")
}
...
func (UnimplementedGatewayServiceServer) ExportWorkspaceConfig(context.Context, *ExportWorkspaceConfigRequest) (*ExportWorkspaceConfigResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ExportWorkspaceConfig not implemented")
}
...
func _GatewayService_PutObjectStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GatewayServiceServer).PutObjectStream(&grpc.GenericServerStream[PutObjectRequest, PutObjectResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GatewayService_PutObjectStreamServer = grpc.ClientStreamingServer[PutObjectRequest, PutObjectResponse]
...
func _GatewayService_AttachToContainer_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GatewayServiceServer).AttachToContainer(&grpc.GenericServerStream[ContainerStreamMessage, AttachToContainerResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GatewayService_AttachToContainerServer = grpc.BidiStreamingServer[ContainerStreamMessage, AttachToContainerResponse]
