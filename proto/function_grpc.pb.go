...
const (
	...
	FunctionService_FunctionInvokeGang_FullMethodName = "/function.FunctionService/FunctionInvokeGang"
...
type FunctionServiceClient interface {
	...
	FunctionInvokeGang(ctx context.Context, in *FunctionInvokeGangRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[FunctionInvokeGangResponse], error)
...
func (c *functionServiceClient) FunctionInvokeGang(ctx context.Context, in *FunctionInvokeGangRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[FunctionInvokeGangResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &FunctionService_ServiceDesc.Streams[1], FunctionService_FunctionInvokeGang_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[FunctionInvokeGangRequest, FunctionInvokeGangResponse]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type FunctionService_FunctionInvokeGangClient = grpc.ServerStreamingClient[FunctionInvokeGangResponse]
...
func (c *functionServiceClient) FunctionMonitor(ctx context.Context, in *FunctionMonitorRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[FunctionMonitorResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &FunctionService_ServiceDesc.Streams[2], FunctionService_FunctionMonitor_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type FunctionServiceServer interface {
	...
	FunctionInvokeGang(*FunctionInvokeGangRequest, grpc.ServerStreamingServer[FunctionInvokeGangResponse]) error
...
func (UnimplementedFunctionServiceServer) FunctionInvoke(*FunctionInvokeRequest, grpc.ServerStreamingServer[FunctionInvokeResponse]) error {
	return status.Error(codes.Unimplemented, "method FunctionInvoke not implemented")
}
func (UnimplementedFunctionServiceServer) FunctionInvokeGang(*FunctionInvokeGangRequest, grpc.ServerStreamingServer[FunctionInvokeGangResponse]) error {
	return status.Error(codes.Unimplemented, "method FunctionInvokeGang not implemented")
}
func (UnimplementedFunctionServiceServer) FunctionGetArgs(context.Context, *FunctionGetArgsRequest) (*FunctionGetArgsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FunctionGetArgs not implemented")
}
func (UnimplementedFunctionServiceServer) FunctionSetResult(context.Context, *FunctionSetResultRequest) (*FunctionSetResultResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FunctionSetResult not implemented")
}
func (UnimplementedFunctionServiceServer) FunctionMonitor(*FunctionMonitorRequest, grpc.ServerStreamingServer[FunctionMonitorResponse]) error {
	return status.Error(codes.Unimplemented, "method FunctionMonitor not implemented")
}
func (UnimplementedFunctionServiceServer) FunctionSchedule(context.Context, *FunctionScheduleRequest) (*FunctionScheduleResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FunctionSchedule not implemented")
}
...
func _FunctionService_FunctionInvokeGang_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(FunctionInvokeGangRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(FunctionServiceServer).FunctionInvokeGang(m, &grpc.GenericServerStream[FunctionInvokeGangRequest, FunctionInvokeGangResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type FunctionService_FunctionInvokeGangServer = grpc.ServerStreamingServer[FunctionInvokeGangResponse]
...
var FunctionService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "FunctionInvokeGang",
			Handler:       _FunctionService_FunctionInvokeGang_Handler,
			ServerStreams: true,
		},
		{
