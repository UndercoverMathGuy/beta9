...
func (UnimplementedOutputServiceServer) OutputSaveStream(grpc.ClientStreamingServer[OutputSaveRequest, OutputSaveResponse]) error {
	return status.Error(codes.Unimplemented, "method OutputSaveStream not implemented")
}
func (UnimplementedOutputServiceServer) OutputStat(context.Context, *OutputStatRequest) (*OutputStatResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method OutputStat not implemented")
}
func (UnimplementedOutputServiceServer) OutputPublicURL(context.Context, *OutputPublicURLRequest) (*OutputPublicURLResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method OutputPublicURL not implemented")
}
...
func RegisterOutputServiceServer(s grpc.ServiceRegistrar, srv OutputServiceServer) {
	// If the following call panics, it indicates UnimplementedOutputServiceServer was
